...
## `allowCreateInSelect`
При установке флага в `true` при поиске в автоматически сгенерированных
элементах типа Select при отсутсвии элементов будет предложена опция
быстрого создания сущности.
