...
Текущий пользователь доступен в поле `user` приложения. В форме - `this.app.user`;
...
На странице авторизации можно включить возможность выбора 
имени пользователя из списка. Для этого и в клиентском и в серверном
приложении необходимо установить флаг `showUsersList`
````
